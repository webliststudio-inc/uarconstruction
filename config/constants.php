<?php
	...
	$appName='Urban and Rural Construction LLC'; 

	//$websiteUrl='https://uarconstruction.com'; /// For Live Server Url //
	$websiteUrl='http://localhost/weblist-studio/uarconstruction.com';
	//$websiteUrl='http://10.143.4.177/weblist-studio/uarconstruction.com';
	//$websitePath = $_SERVER['DOCUMENT_ROOT'];
	$websitePath = $_SERVER['DOCUMENT_ROOT'].'/weblist-studio/uarconstruction.com'; //dirname(__FILE__);
