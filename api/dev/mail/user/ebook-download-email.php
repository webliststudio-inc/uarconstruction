...
$recieverName=$loginUserFullname;
$sendTo=$loginUserEmail;
...
<div style="width:100%; background:#f4f6f8; padding:30px 0; font-family:Arial, Helvetica, sans-serif;">
    <div style="max-width:700px; margin:auto; background:#ffffff; border-radius:8px; overflow:hidden; box-shadow:0 4px 10px rgba(0,0,0,0.08);">
        ...
        <div style="padding:30px; color:#333;">
            ...
            <h2 style="color:#3C8C29; margin-top:0;">Ebook Download Successful</h2>

            <p>Dear <strong>'.$loginUserFullname.'</strong>,</p>

            <p>Your ebook purchase is successful.</p>

            <!-- ================= USER DETAILS ================= -->
            <h3 style="color:#3C8C29; margin-top:30px;">Cutomer Details</h3>
            <table width="100%" cellpadding="8" cellspacing="0" style="border-collapse:collapse; font-size:14px;">
                <tr style="background:#f9fafb;">
                    <td style="border:1px solid #eee;"><strong>Full Name</strong></td>
                    <td style="border:1px solid #eee;">'.$loginUserFullname.'</td>
                </tr>
                <tr style="background:#f9fafb;">
                    <td style="border:1px solid #eee;"><strong>Email Address</strong></td>
                    <td style="border:1px solid #eee;">'.$loginUserEmail.'</td>
                </tr>
                <tr style="background:#f9fafb;">
                    <td style="border:1px solid #eee;"><strong>Phone Number</strong></td>
                    <td style="border:1px solid #eee;">'.$loginUserPhoneNumber.'</td>
                </tr>
            </table>
            ...
            <table width="100%" cellpadding="8" cellspacing="0" style="border-collapse:collapse; font-size:14px;">
                <tr style="background:#f9fafb;">
                    <td style="border:1px solid #eee;"><strong>Title</strong></td>
                    <td style="border:1px solid #eee;">'.$ebookTitle.'</td>
                </tr>
                <tr style="background:#f9fafb;">
                    <td style="border:1px solid #eee;"><strong>Amount</strong></td>
                    <td style="border:1px solid #eee;">'.$amount.'</td>
                </tr>
                <tr style="background:#f9fafb;">
                    <td style="border:1px solid #eee;"><strong>Link</strong></td>
                    <td style="border:1px solid #eee;">'.$ebookFilePath.'/'.$material.'</td>
                </tr>
            </table>
