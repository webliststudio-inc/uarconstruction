...
<div style="width:100%; background:#f4f6f8; padding:30px 0; font-family:Arial, Helvetica, sans-serif;">
    <div
        ...
        <div style="padding:30px; color:#333;">
            ...
            <h2 style="color:#07418d; margin-top:0;">New Contact Message Received</h2>
            ...
            <div
                style="background:#f9fafb; border-left:4px solid #07418d; padding:15px; border-radius:5px; line-height:1.6;">
                ' . $message . '
            </div>

            <div style="margin-top:30px; text-align:center;">
                <a href="mailto:' . $emailAddress . '"
                    style="background:#07418d; color:#ffffff; padding:12px 22px; text-decoration:none; border-radius:5px; font-weight:bold; display:inline-block;">
                    Reply to Sender
                </a>
            </div>
