...
try {
    ...
    // Check for duplicate product name at level 1
    $checkQuery = "SELECT * FROM PRODUCTS_TAB WHERE productLevel = 1 AND productName = ? AND productId != ?";
    ...
    $updateQuery = "
        ...
        WHERE productId = ?
    ";
    updateQuery($conn, $updateQuery, "sssss", [$productName, $productTags, $statusId, $loginStaffId, $productId]);
    ...
    $response = [
        ...
        'oldProductPixNames' => $oldProductPixNames,
